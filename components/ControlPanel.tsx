...
interface ControlPanelProps {
    ...
    setUpscaleEngine: (engine: UpscaleEngine) => void;
}
...
export const ControlPanel: React.FC<ControlPanelProps> = (props) => {
    ...
    const engines: { id: UpscaleEngine; label: string; tooltip: string }[] = [
        { id: 'generative', label: t('engineGenerative'), tooltip: t('engineGenerativeTooltip') },
        { id: 'fidelity', label: t('engineFidelity'), tooltip: t('engineFidelityTooltip') },
    ];
    ...
    return (
        <div className="w-full max-w-5xl p-4 bg-slate-800/50 rounded-xl border border-slate-700 flex flex-col gap-4 animate-fade-in">
            <div className="flex flex-col gap-6">
                ...
                {upscaleEngine === 'generative' && (
                    <div className="animate-fade-in border-t border-slate-700/50 pt-4 flex flex-col gap-6">
